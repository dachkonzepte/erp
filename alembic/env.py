"""Alembic-Umgebung fuer das DACHKONZEPTE ERP.

Nutzt bewusst dieselbe DATABASE_URL-Umgebungsvariable wie die App selbst
(siehe app/database.py), damit es nur eine Stelle fuer die Verbindung gibt.
target_metadata zeigt auf Base.metadata aus den bestehenden SQLAlchemy-
