...
from .routers import (
    absence_requests, account, accounts, address_import, ai_settings, audit, auth, calendar_events, catalogs, changelog, customer_documents, customers,
...
app.include_router(outlook_sync_settings.router)
