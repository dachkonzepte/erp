...
def get_document_email_template(document_type: str, db: Session = Depends(get_db)):
...
def put_document_email_template(document_type: str, payload: DocumentEmailTemplateUpdate, db: Session = Depends(get_db)):
    _validate_document_type(document_type)
